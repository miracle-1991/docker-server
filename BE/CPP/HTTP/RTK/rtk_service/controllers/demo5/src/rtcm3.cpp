...
static int decode_type1019(rtcm_t *rtcm)
{
    ...
    trace(5,"decode_type1019: prn=%d iode=%d toe=%.0f\n",prn,eph.iode,eph.toes);
...
static int decode_type1020(rtcm_t *rtcm)
{
    ...
    trace(5,"decode_type1020: prn=%d tk=%02.0f:%02.0f:%02.0f\n",prn,tk_h,tk_m,tk_s);
...
static int decode_type1045(rtcm_t *rtcm)
{
    ...
    trace(5,"decode_type1045: prn=%d iode=%d toe=%.0f\n",prn,eph.iode,eph.toes);
...
static int decode_type1046(rtcm_t *rtcm)
{
    ...
    trace(5,"decode_type1046: prn=%d iode=%d toe=%.0f\n",prn,eph.iode,eph.toes);
...
static int decode_type1042(rtcm_t *rtcm)
{
    ...
    trace(5,"decode_type1042: prn=%d iode=%d toe=%.0f\n",prn,eph.iode,eph.toes);
...
extern int decode_rtcm3(rtcm_t *rtcm)
{
    ...
    trace(5,"decode_rtcm3: len=%3d type=%d\n",rtcm->len,type);
